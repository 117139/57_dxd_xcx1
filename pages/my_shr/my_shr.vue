		...
		<view class="add_list">
			<view class="add_li dis_flex ju_b" v-for="(item,index) in datas">
				...
				<view class="add_r dis_flex_c ju_a aic">
					...
					<text @tap="jump" :data-url="'/pages/my_shr_edit/my_shr_edit?address='+JSON.stringify(item)">编辑</text>
				</view>
			</view>
		</view>
		<view class="add_btn" style="opacity: 0;">新增地址</view>
		<view class="b_b_btns">
			<view class="add_btn" @tap="jump" data-url="/pages/my_shr_edit/my_shr_edit">新增收货人</view>
		</view>
	</view>
</template>
